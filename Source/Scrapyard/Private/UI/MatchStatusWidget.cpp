...
// this shouldn't happen
      UE_LOG(LogTemp, Warning, TEXT("%s::OnReadyToStartMatch - called outside of WaitingToStart state"), *GetName());
    }
  } 
...
{
  UE_LOG(LogTemp, Warning, TEXT("%s::ShowScreenBlocker"), *GetName()); 
