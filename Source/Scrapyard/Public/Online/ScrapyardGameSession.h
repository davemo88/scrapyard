...
protected:
	...
	TSharedPtr<class FScrapyardOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AScrapyardGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AScrapyardGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(AScrapyardGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AScrapyardGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
