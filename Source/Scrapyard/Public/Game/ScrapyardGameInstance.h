...
class FScrapyardPendingMessage
{
public:
...
class FScrapyardPendingInvite
{
public:
	FScrapyardPendingInvite() : ControllerId(-1), UserId(nullptr), bPrivilegesCheckedAndAllowed(false) {}
...
//	void SetPendingInvite(const FScrapyardPendingInvite& InPendingInvite);
...
private:
	...
	FScrapyardPendingMessage PendingMessage;

	FScrapyardPendingInvite PendingInvite;
